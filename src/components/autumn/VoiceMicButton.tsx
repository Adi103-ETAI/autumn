      ...
      <AnimatePresence>
        {showListeningUI && (
          <motion.div
            ...
            className="pointer-events-auto mb-1 max-w-xs rounded-xl border border-amber-500/30 bg-zinc-900/95 px-3 py-2 shadow-lg shadow-black/40 backdrop-blur"
          >
      ...
      <div className="relative pointer-events-auto">
        ...
        <button
          ...
          className={cn(
            ...
            showListeningUI
              ? "border-amber-400/60 bg-amber-500/20 text-amber-300 shadow-lg shadow-amber-500/30"
              : voiceEnabled
                ? "border-border/70 bg-zinc-900/80 text-zinc-200 hover:border-amber-400/50 hover:text-amber-300 shadow-lg shadow-black/30"
                : "border-border/70 bg-zinc-900/80 text-zinc-300 hover:text-amber-300 hover:border-amber-400/50 shadow-lg shadow-black/30",
          )}
        >
          <Mic
            className={cn(
          ...
          {!voiceEnabled && (
            <span
              aria-hidden
              className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-bold text-black shadow-md shadow-amber-500/40 ring-2 ring-zinc-950"
            >
              1
            </span>
          )}
