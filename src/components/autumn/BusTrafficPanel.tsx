...
function BusTrafficCard({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onToggle}
        className="block w-full text-left text-[11px] text-muted-foreground italic pl-1 border-l-2 border-amber-500/30 hover:border-amber-500/60 transition-colors"
      >
