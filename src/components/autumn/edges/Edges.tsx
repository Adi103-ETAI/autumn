  ...
  return (
    ...
    >
      <input
        ...
        className="w-24 rounded-md border border-amber-500/50 bg-card/95 px-2 py-0.5 text-[9px] uppercase tracking-wider text-amber-300 text-center focus:outline-none focus:ring-1 focus:ring-violet-500/70"
      ...
      <EdgeLabelRenderer>
        {editing ? (
          ...
          <button
            ...
            className="rounded-full bg-amber-500/15 border border-violet-500/30 px-1.5 py-0.5 text-[8px] uppercase tracking-wider text-amber-300/90 nodrag nopan hover:bg-amber-500/30 hover:border-amber-500/50 hover:scale-110 transition-all cursor-pointer"
            onDoubleClick={(e) => {
              e.stopPropagation();
              setEditing(true);
            }}
  ...
  return (
    <EdgeLabelRenderer>
      ...
      >
        ...
        `}</style>
        <div className="flex items-center gap-1 rounded-full bg-violet-500/90 border border-amber-300 px-2 py-0.5 shadow-lg shadow-violet-500/40 -translate-x-1/2 -translate-y-1/2 max-w-[180px]">
